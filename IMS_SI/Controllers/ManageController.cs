    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                else if (UserManager.IsInRole(user.Id, UserRoles.Nurse))
                {
                    return RedirectToAction("Index", "Nurse", new { Message = "Password has been Reset" });
                }
                else if (UserManager.IsInRole(user.Id, UserRoles.Receptionist))
                {
                    return RedirectToAction("Index", "Receptionist", new { Message = "Password has been Reset" });
                }
